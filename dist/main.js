...
var SDK = function (Utils, Support) {
  ...
  _.nativeCheck = function (timeout) {
    return new Promise(function (resolve, reject) {
      ...
      window.AssinaMeExtension.nativeVersion(timeout).then(function (response) {
        hasNative = true;
  ...
  return _;
}(_utils2.default, new _support2.default(_utils2.default.currentBrowser(), _utils2.default.currentOS()));
